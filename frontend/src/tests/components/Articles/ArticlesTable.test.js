...
describe("ArticlesTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-title`)).toHaveTextContent("Cat Article");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("3");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-title`)).toHaveTextContent("Dog Article");

    expect(screen.getByTestId(`${testId}-cell-row-2-col-id`)).toHaveTextContent("4");
    expect(screen.getByTestId(`${testId}-cell-row-2-col-title`)).toHaveTextContent("Lizard Article");
