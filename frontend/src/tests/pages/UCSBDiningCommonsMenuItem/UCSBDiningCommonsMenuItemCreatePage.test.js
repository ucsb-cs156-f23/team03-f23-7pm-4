...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /diningcommonsmenuitem", async () => {
        ...
        fireEvent.change(diningcommonscodeInput, { target: { value: 'De La Guerra' } })
        fireEvent.change(nameInput, { target: { value: 'Fried Tacos' } })
        fireEvent.change(stationInput, { target: { value: 'Mexican Bar' } })
        ...
        expect(mockToast).toBeCalledWith("New UCSB Dining Commons Menu Item Created - id: 4 name: Fried Tacos");
